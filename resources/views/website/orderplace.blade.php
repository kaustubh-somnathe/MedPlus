		   			...
		   			<div class="row">
			   			<div class="col-sm-8 col-sm-offset-2 slider-text">
			   				<div class="col-md-12">
								...
								<div class="otp-section-div col-sm-10 col-sm-offset-2" style="text-align: center; margin-top: 60px; width: 600px; height: 200px; background-color: #ffff; padding: 30px;">
									<h2 class="otp-heading" style="padding-bottom: 20px;"><b>Order Placed</b></h2>
						              <h3><p>Order ID : <input type="" name="" value="{{$oderData->order_id}}" style="width: 350px; text-align: center;"disabled></p></h3>
								</div>
							</div>
   						</div>
	   				</div>
